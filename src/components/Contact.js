            ...
            <div className="contact-container">
                ...
                >
                    ...
                    <p className="section-subtitle">
                        I'm currently seeking frontend development opportunities. 
                ...
                <div 
                    ref={linksRef}
                    className={`contact-links stagger-children ${linksVisible ? 'visible' : ''}`}
                >
                    <a href="mailto:keandresadler@gmail.com" className="contact-method">
                        <div className="method-info">
                            <span className="method-label">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="label-icon">
                    ...
                    >
                        <div className="method-info">
                            <span className="method-label">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="label-icon">
